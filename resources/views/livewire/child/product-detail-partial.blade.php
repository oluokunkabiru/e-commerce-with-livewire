<div class="row p-relative">
        ...
        <div class="tab-content" id="ex1-content">
            @foreach ($product->details as $attr)
                <div class="tab-pane fade {{ $attr->id == $attribute ? 'show active' : '' }}" id="img{{ $attr->id }}"
                    ...
                    <img observe="true" observe-src="{{  $attr->getMedia('products')->first() !=null ?$attr->getMedia('products')->first()->getFUllUrl():null }}" styl="width:100%; height:150px; object-fit:cover" class="img-fluid" alt="">
            ...
            @foreach ($product->details as $attr)
                <li class="nav-item" role="presentation">
                    <a wire:click='attribute({{ $attr->id }})'
                        ...
                        aria-selected="true">
                        <img observe="true" observe-src="{{  $attr->getMedia('products')->first() !=null ?$attr->getMedia('products')->first()->getFUllUrl():null }}" style="width:100%; height:150px; object-fit:cover" class="img-fluid"
                            alt="">
    ...
    <div class="col-md-7 col-sm-12">
        ...
        <div class="d-flex">
            <p class="smaller-font mr-3 text-gray text-line-through">₦{{ number_format($attributeArr->price2) }}
            </p>
            <p class="smaller-font text-black">₦{{ number_format($attributeArr->price, 2) }}</p>
        </div>
